# Operator Quickstart — Residential Nursing Care Facilities

Shortest path from clone to a verified local dry-run for **ISIC 871** (`cloud-itonami-isic-871`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-871.git
cd cloud-itonami-isic-871
```
...
- Blueprint governor key: `nursing-care-governor`
- Likely source path: `nursingcareops.governor.cljc`
